...
class CalcViewController: UIViewController {
    ...
    @IBOutlet weak var calculatorView: UIView!  // → 💡 Tip: Unwrapping Optionals - if this label is not connected then the app will crash!
    ...
    private lazy var calculatorEngine: CalculatorAPI = {
        Calculator() {
